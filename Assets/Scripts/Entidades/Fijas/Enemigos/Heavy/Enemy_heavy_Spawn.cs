...
public class Enemy_heavy_Spawn : MonoBehaviour
{
    Rigidbody2D rb2d;
    SpriteRenderer sr;
    public float speed;
    public List<Sprite> sprites;
    public Enemy_havy_Manager manager;
    public GameObject particulasMuerte;

    // Start is called before the first frame update
    void Start()
    {
        manager.actual_heavy_enemies++;
...
public void Muerte()
{
    if (transform.localScale.x > 0.25f)
    {
        ...
        temp1.GetComponent<Enemy_heavy_Spawn>().manager = manager;
        ...
        temp2.GetComponent<Enemy_heavy_Spawn>().manager = manager;
