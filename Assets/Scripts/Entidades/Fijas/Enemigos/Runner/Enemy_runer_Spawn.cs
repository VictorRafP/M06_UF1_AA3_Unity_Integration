...
public class Enemy_runer_Spawn : MonoBehaviour
{
    Rigidbody2D rb2d;
    SpriteRenderer sr;
    public float speed;
    public List<Sprite> sprites;
    public Enemy_runer_Manager manager;
    public GameObject particulasMuerte;

    // Start is called before the first frame update
    void Start()
    {
        manager.actual_runer_enemies++;
...
public void Muerte()
{
    if (transform.localScale.x > 0.25f)
    {
        ...
        temp1.GetComponent<Enemy_runer_Spawn>().manager = manager;
        ...
        temp2.GetComponent<Enemy_runer_Spawn>().manager = manager;
